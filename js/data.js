const portfolioData = {
  personal: {
    name: "SUMIT KUMAR SUMAN",
    monogram: "SKS",
    badgeLabel: "PORTFOLIO",
    role: "Business Analyst | Business Analytics Professional",
    targetRoles: "MBA Business Analytics | Business Analyst | BI & Data Analytics",
    location: "Punjab / India",
    email: "sks110498@gmail.com",
    phone: "8555962911",
    linkedin: "https://linkedin.com/in/sumit-kumar-suman",
    github: "https://github.com/suman110498",
    resumeUrl: "assets/resume/SumitKrSuman12515171SpecializedCV.pdf",
  ...
  about: {
    ...
    summary: `MBA Business Analytics student with a strong technical foundation in Computer Science & Engineering. Specializing in bridging data analytics with strategic business decisions through robust data modeling, visualization, predictive modeling, and exploratory analytics.

With hands-on experience in business analytics, sales auditing, KPI tracking, and statistical modeling, I focus on translating complex multidimensional enterprise data into actionable executive recommendations that drive operational excellence and revenue growth.`,
    highlights: [
      ...
      "Combines engineering problem-solving with rigorous statistical and business analytics methodologies."
    ]
  },
    ...
    categories: [
      {
        ...
        items: [
          ...
          "Python (Pandas, NumPy)",
          "Advanced Excel (VLOOKUP, Pivot, Solver)",
      ...
      },
      {
        ...
        items: [
          ...
          "Sales Funnel & Conversion Auditing",
  ...
  ticker: [
    { num: "290+", label: "LEADS AUDITED" },
    { num: "22", label: "QUALIFIED LEADS" },
    { num: "100+", label: "SALES CALLS ANALYSED" },
    { num: "10+", label: "EVENTS MANAGED" },
    { num: "100+", label: "EVENT PARTICIPANTS" },
    { num: "1,000+", label: "LINKEDIN IMPRESSIONS" },
    { num: "27,900+", label: "FINANCIAL TRANSACTIONS" },
    { num: "60K+", label: "TRANSACTIONS ANALYSED" },
    { num: "18K+", label: "CUSTOMERS ANALYSED" },
    { num: "3,921", label: "CUSTOMERS IN CLV ANALYSIS" },
    { num: "R² 0.967", label: "CLV MODEL" }
  ],
  ...
  education: [
    {
      ...
      grade: "CGPA: 8.55",
      status: "Pursuing",
      details: "Focusing on Business Intelligence, Predictive Analytics, Financial & Marketing Analytics, and Enterprise Big Data frameworks."
    },
    {
      degree: "Bachelor of Technology (CSE)",
      institution: "Lovely Professional University",
      location: "Phagwara, Punjab",
      duration: "Jul 2017 – Apr 2021",
      dates: "Jul 2017 – Apr 2021",
      grade: "Percentage: 73%",
      status: "Completed",
      details: "Core engineering foundation in algorithms, database management systems, data structures, and software architecture."
    },
    {
      degree: "Intermediate",
      institution: "Bhavan’s Sri Jr College",
      location: "Secunderabad, Telangana",
      duration: "Apr 2016 – May 2017",
      dates: "Apr 2016 – May 2017",
      grade: "Percentage: 86%",
      status: "Completed",
      details: "Senior secondary education with strong foundational mastery in mathematics, sciences, and analytical problem-solving."
    }
  ],
  ...
  experience: [
    {
      ...
      companyShort: "Zorgers Home Healthcare",
      location: "Mohali, Punjab, India",
      duration: "Jun 2026 – Jul 2026",
      period: "Jun 2026 – Jul 2026",
      type: "Internship",
      logo: "assets/zorgers_logo.png",
      subInitiative: "HOME HEALTHCARE & ASSISTED LIVING ANALYTICS",
      description: "Conducted sales compliance audits, predictive dashboard development, sales call analysis, market basket mining, and competitive market assessments for executive decision-making.",
      summary: "Conducted sales compliance audits, predictive dashboard development, sales call analysis, market basket mining, and competitive market assessments for executive decision-making.",
      kpis: [
        { label: "LEADS AUDITED", value: "290", suffix: "+" },
        { label: "QUALIFIED LEADS", value: "22", suffix: "" },
        { label: "CALLS ANALYSED", value: "100", suffix: "+" },
        { label: "MONTHS AUDITED", value: "7", suffix: " Mo" },
        { label: "INVESTOR DECK PAGES", value: "3", suffix: " Pages" },
        { label: "COMPETITORS BENCHMARKED", value: "20", suffix: "+" }
      ],
      responsibilities: [
        "Audited 290+ leads over 7 months to assess sales compliance, service quality and brand representation, identifying operational gaps and generating 22 qualified leads.",
        "Visualised key business KPIs using a Power BI predictive analytics dashboard, tracking revenue, ARPU, customer count, churn, retention and LTV to identify revenue and customer-value opportunities for business planning.",
        "Analysed 100+ sales calls to identify communication gaps, recurring customer objections and effective sales practices, and translated these insights into the call-flow structure for Zorgers’ AI Call Agent.",
        "Leveraged Market Basket Analysis and Association Rule Mining to identify frequently purchased healthcare equipment combinations and recommend bundling, cross-selling and upselling opportunities.",
        "Conducted PAN-India market and competitor analysis evaluating market potential, competitive presence and service gaps; translated findings into 3 investor deck pages to support expansion and scaling decisions."
      ],
      highlightsSlides: [
        {
  ...
  featuredProjects: [
    {
      ...
      githubUrl: "https://github.com/suman110498/Revenue-Concentration-Product-Mix-Retention-",
      dashboardUrl: ""
    },
    {
      id: "proj-2",
      ...
      githubUrl: "https://github.com/suman110498/Project-Delivery-Risk-Resource-Analytics-",
      dashboardUrl: ""
    },
    {
      id: "proj-3",
      ...
      githubUrl: "https://github.com/suman110498/Customer-Value-Intelligence-Behavioral-Segmentation-",
      dashboardUrl: ""
    },
    {
      id: "proj-4",
      ...
      githubUrl: "https://github.com/suman110498/Advanced-Financial-Analytics-Insights-",
      dashboardUrl: ""
    },
    {
      id: "proj-5",
      ...
      githubUrl: "https://github.com/suman110498/Predictive-Customer-Lifetime-Value-CLV-Analytics",
      dashboardUrl: ""
    },
    {
      id: "proj-6",
      ...
      githubUrl: "https://github.com/suman110498",
      dashboardUrl: ""
    }
  ],
  ...
  activities: {
    role: "General Secretary | Event Data & Operation Lead",
    organization: "Mission Power Skills Club",
    duration: "Mar 2026 – Present",
    metrics: [
      { value: "10+", label: "Events Coordinated" },
      { value: "100+", label: "Active Event Participants" },
      { value: "1,000+", label: "LinkedIn Impressions" }
    ],
    highlights: [
      "Coordinated and managed 10+ events with 100+ participants, overseeing participant coordination, group formation, execution, and on-ground operations.",
  ...
  achievements: [
    {
      number: "01",
      icon: "users",
      title: "Group Discussion Event – Smart Symposium 2.0",
      result: "Participant",
      date: "Feb 2026",
      description: "Participated in Group Discussion Event – Smart Symposium 2.0 demonstrating structured analytical perspective and communication skills."
    },
    {
      number: "02",
      icon: "trophy",
      ...
      result: "Gold Medal",
      date: "Sep 2019",
      description: "Achieved Gold Medal in the Inter-College Science Quiz."
    }
  ],
  ...
  contact: {
    ...
    resumePdf: "assets/resume/SumitKrSuman12515171SpecializedCV.pdf",
    cards: [
      {
        type: "email",
        label: "EMAIL",
        value: "sks110498@gmail.com",
        href: "mailto:sks110498@gmail.com",
        icon: "mail"
      },
      {
        type: "phone",
      ...
      },
      {
        type: "linkedin",
        label: "LINKEDIN",
        value: "linkedin.com/in/sumit-kumar-suman",
        href: "https://linkedin.com/in/sumit-kumar-suman",
        icon: "linkedin"
      },
      {
        type: "github",
        label: "GITHUB",
        value: "github.com/suman110498",
        href: "https://github.com/suman110498",
        icon: "github"
      }
    ]
  }
