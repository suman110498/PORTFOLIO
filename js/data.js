  ...
  education: [
    {
      ...
      status: "Pursuing",
      grade: "Pursuing",
      details: "Specializing in Business Intelligence, Predictive Analytics, Financial Modelling, and Enterprise Decision Analytics with engineering-rooted rigor."
    },
    {
      ...
      status: "Graduated",
      grade: "Completed",
      details: "Comprehensive foundation in computer systems, relational database architecture, object-oriented programming, algorithms, and data engineering."
    },
    {
      degree: "Intermediate / Higher Secondary (12th)",
      institution: "B.S.S. Inter College",
      location: "Bihar, India",
      dates: "2014 – 2016",
      status: "Completed",
      grade: "Completed",
      details: "Science Stream (Mathematics, Physics, Chemistry) with analytical, numerical, and logic foundations."
    },
    {
      degree: "Matriculation / Secondary School (10th)",
      institution: "G.B. High School",
      location: "Bihar, India",
      dates: "2013 – 2014",
      status: "Completed",
      grade: "Completed",
      details: "Foundational secondary education with distinction in mathematics and science."
    }
  ],
  ...
  experience: [
    {
      ...
      company: "Zorgers Home Healthcare Pvt. Ltd. & The Vintage Club",
      companyShort: "Zorgers & The Vintage Club",
      location: "Mohali, Punjab, India",
      period: "May 2025 – Jul 2025",
      type: "Internship",
      logo: "assets/images/zorgers_logo.png",
      summary: "Evaluated 200+ sales calls, analyzed multi-channel conversion funnels, benchmarked 20+ competitors in assisted-living, and built regression models for Mohali bed-capacity planning.",
      kpis: [
        { label: "SALES CALLS AUDITED", value: "200", suffix: "+" },
        { label: "LEADS ANALYSED", value: "290", suffix: "+" },
        { label: "MONTHS OF DATA", value: "7", suffix: " Mo" },
        { label: "QUALIFIED LEADS", value: "22", suffix: "" },
        { label: "COMPETITORS BENCHMARKED", value: "20", suffix: "+" },
        { label: "EXPANSION CITIES", value: "Top 5", suffix: "" }
      ],
      responsibilities: [
        "Audited 200+ sales calls and 290+ customer records to identify revenue leakages and upselling opportunities",
        "Analysed lead conversion funnels across 7 months (119 leads, 15 conversions), surfacing a 12.61% conversion baseline",
        "Benchmarked 20+ assisted-living competitors on pricing, capacity, and service models",
